...
I would say that semantic HTML is HTML that is used to give meaning to your content and not just used for design purposes.
...
It allows multiple people to work on the same project and keep track of individual updates and saves.
